...
const APBlogList = () => {
  ...
  const handleActivate = async (slug) => {
    try {
      const confirmationResult = await Swal.fire({
        title: "Activate Blog?",
        text: "Do you want to Activate this Blog?",
        icon: "question",
      ...
      if (confirmationResult.isConfirmed) {
        // setLoading(true);
        const response = await axios.post(
          BaseApi + `/admin/blog/admin_activateblog/${slug}`,
          null, // Pass null as the request body if not required
          {
            headers: {
              "Content-Type": "application/json",
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Blog Activated successfully!",
            icon: "success",
  ...
  const handleDeactivate = async (slug) => {
    try {
      const confirmationResult = await Swal.fire({
        ...
        text: "Do you want to Deactivate this Blog?",
        icon: "question",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
      ...
      if (confirmationResult.isConfirmed) {
        // setLoading(true);
        const response = await axios.post(
          BaseApi + `/admin/blog/admin_deactivateblog/${slug}`,
          null, // Pass null as the request body if not required
          {
            headers: {
              "Content-Type": "application/json",
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Blog Deactivated successfully!",
            icon: "success",
            confirmButtonText: "Close",
          });
        } else {
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Deactivate Blog",
        icon: "error",
        confirmButtonText: "Close",
      });
  ...
  const handleDelete = async (slug) => {
    try {
      ...
      if (confirmationResult.isConfirmed) {
        // setLoading(true);
        const response = await axios.post(
          BaseApi + `/admin/blog/admin_deleteblogs/${slug}`,
          null, // Pass null as the request body if not required
          {
            headers: {
              "Content-Type": "application/json",
  ...
  const handleMultipleDeactivate = async () => {
    try {
      const confirmationResult = await Swal.fire({
        title: "Deactivate Blogs?",
        text: "Do you want to Deactivate these Blogs?",
        icon: "question",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Blogs Deactivated successfully!",
            icon: "success",
            confirmButtonText: "Close",
          });
        } else {
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Deactivate Blogs",
        icon: "error",
        confirmButtonText: "Close",
      });
      console.log("Couldn't deactivate the record!", error.message);
  ...
  const handleMultipleActivate = async () => {
    try {
      const confirmationResult = await Swal.fire({
        title: "Activate Blogs?",
        text: "Do you want to Activate these Blogs?",
        icon: "question",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Blogs Activated successfully!",
            icon: "success",
            confirmButtonText: "Close",
          });
        } else {
          ...
          <>
            <div className="site-min-height">
              ...
              <div className="ManageSubAdminHeader">
                <h2 className="">Blog List</h2>
                {(userAccess[6]?.Add === 1 || adminID === "1")&& <>
                <button
                  className="btn navButton1 APMSbutton"
                  onClick={() => navigate("/admin/blogs/addblogs")}
                >
                  Add Blog
                </button>
                </>}
                  ...
                  <div className="manageSubadminPart1">
                    <form>
                      <div className="manageSubadminPart1Sec1">
                        <h4>Search Blog by typing title or Created date</h4>
                            ...
                            <>
                              <tr>
                                ...
                                <td className="APActionButton">
                                  ...
                                  {(userAccess[6]?.Edit === 1 || adminID === "1")&& <>
                                  <button
                                    className="btn-primary"
                                    onClick={() =>
                                      navigate(
                                        `/admin/blogs/editblogs/${i.slug}`
                                      )
                                    }
                                  >
                                    <Tooltip title="Edit">
                                  ...
                                  {(userAccess[6]?.Delete === 1 || adminID === "1")&& <>
                                  <button
