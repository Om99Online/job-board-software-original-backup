...
const APCurrencyList = () => {
  ...
  const handleActivate = async (slug) => {
    try {
      const confirmationResult = await Swal.fire({
        ...
        text: "Do you want to Activate this Currency?",
        icon: "question",
      ...
      if (confirmationResult.isConfirmed) {
        // setLoading(true);
        const response = await axios.post(
          BaseApi + `/admin/currency/admin_activate/${slug}`,
          null, // Pass null as the request body if not required
          {
            headers: {
              "Content-Type": "application/json",
      ...
      Swal.fire({
        ...
        text: "Could not Activate Currency",
        icon: "error",
        confirmButtonText: "Close",
      });
  ...
  const handleDeactivate = async (slug) => {
    try {
      const confirmationResult = await Swal.fire({
        ...
        text: "Do you want to Deactivate this Currency?",
        icon: "question",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
      ...
      if (confirmationResult.isConfirmed) {
        // setLoading(true);
        const response = await axios.post(
          BaseApi + `/admin/currency/admin_deactivate/${slug}`,
          null, // Pass null as the request body if not required
          {
            headers: {
              "Content-Type": "application/json",
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Deactivate Currency",
        icon: "error",
        confirmButtonText: "Close",
      });
  ...
  const handleDelete = async (slug) => {
    try {
      ...
      if (confirmationResult.isConfirmed) {
        // setLoading(true);
        const response = await axios.post(
          BaseApi + `/admin/currency/admin_delete/${slug}`,
          null, // Pass null as the request body if not required
          {
            headers: {
              "Content-Type": "application/json",
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Delete Currency",
        icon: "error",
        confirmButtonText: "Close",
      });
  ...
  const handleMultipleDeactivate = async () => {
    try {
      const confirmationResult = await Swal.fire({
        title: "Deactivate Currency?",
        text: "Do you want to Deactivate these Currency?",
        icon: "question",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Currencies Deactivated successfully!",
            icon: "success",
            confirmButtonText: "Close",
          });
        } else {
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Deactivate Currencies",
        icon: "error",
        confirmButtonText: "Close",
      });
      console.log("Couldn't deactivate the record!", error.message);
  ...
  const handleMultipleActivate = async () => {
    try {
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Currencies Activated successfully!",
            icon: "success",
            confirmButtonText: "Close",
          });
        } else {
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Activate Currencies",
        icon: "error",
        confirmButtonText: "Close",
      });
      console.log("Couldn't activate the record!", error.message);
  ...
  const handleMultipleDelete = async () => {
    try {
      const confirmationResult = await Swal.fire({
        ...
        text: "Do you want to Delete Currencies?",
        icon: "question",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          Swal.fire({
            title: "Currencies Deleted successfully!",
            icon: "success",
            confirmButtonText: "Close",
          });
        } else {
      ...
      Swal.fire({
        title: "Failed. Please try after some time!",
        text: "Could not Delete Currencies",
        icon: "error",
        confirmButtonText: "Close",
      });
      console.log("Couldn't Delete the record!", error.message);
  ...
  const handleCurrencyChange = async (id) => {
    try {
      const response = await axios.post(
        BaseApi + `/admin/currency/admin_defaultcurrency/${id}`,
        null, // Pass null as the request body if not required
        {
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.data.status === 200) {
        Swal.fire({
          title: "Default Currency changed successfully!",
          icon: "success",
          confirmButtonText: "Close",
        });
      } else {
        Swal.fire({
          title: "Couldn't change Default Currency!",
          icon: "error",
          confirmButtonText: "Close",
        });
      }
      ...
      Swal.fire({
        title: "Couldn't change default currency! Try after some time",
        icon: "error",
        confirmButtonText: "Close",
      });
    }
  ...
  const filteredData = listData.filter((item) => {
    ...
    return (
      ...
      item.code.toLowerCase().includes(searchString) ||
      item.symbol.toLowerCase().includes(searchString)
    );
  });
            ...
            <div className="site-min-height">
              <div className="breadCumb1" role="presentation">
                ...
                >
                  ...
                  <Typography color="text.primary">Currency List</Typography>
                </Breadcrumbs>
              </div>
              <div className="ManageSubAdminHeader">
                ...
                <button
                  ...
                  onClick={() => navigate("/admin/currencies/add")}
                >
                  Add Currency
                </button>
                </>}
                              ...
                              <tr>
                                ...
                                <td className="checkBoxCol">
                                  <input
                                    type="checkbox"
                                    className="tableCheckBox"
                                    checked={i.is_default === 1} // Check if the current ID is in checkedData
                                    onChange={() => handleCurrencyChange(i.id)} // Pass the ID to the handler
                                  />
                                </td>
