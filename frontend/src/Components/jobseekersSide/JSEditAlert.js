  ...
  const handleClick = async () => {
    ...
    try {
      ...
      if (editAlert.location === "") {
        newErrors.location = t("jobseekerEditAlert.locationRequired");
        window.scrollTo(0, 0);
      }

      if (editAlert.designation === "") {
        newErrors.designation = t("jobseekerEditAlert.workingRelationRequired");
        window.scrollTo(0, 0);
      }
      ...
      if (Object.keys(newErrors).length === 0) {
        const confirmationResult = await Swal.fire({
          title: t("jobseekerEditAlert.confirmTitle"),
          text: t("jobseekerEditAlert.confirmTxt"),
          icon: "question",
          showCancelButton: true,
          confirmButtonText: t("jobseekerEditAlert.yes"),
          cancelButtonText: t("jobseekerEditAlert.no"),
        });
        if (confirmationResult.isConfirmed) {
          ...
          Swal.fire({
            title: t("jobseekerEditAlert.successTxt"),
            icon: "success",
            confirmButtonText: t("jobseekerEditAlert.close"),
          });
      ...
      Swal.fire({
        title: t("jobseekerEditAlert.failedTxt"),
        icon: "error",
        confirmButtonText: t("jobseekerEditAlert.close"),
      });
            ...
            <div className="row">
              ...
              >
                <div className="d-flex mx-3 PageHeader ">
                  ...
                  <h3 className="mx-2">{t("jobseekerEditAlert.editAlert")}</h3>
                </div>
                <form>
                  <div className="mb-5 mt-5">
                    <div class="form-outline mb-5 DashBoardInputBx">
                      <label class="form-label" for="form3Example1">
                        {t("jobseekerEditAlert.location")}{" "}
                      ...
                      <input
                        ...
                        placeholder={t("jobseekerEditAlert.location")}
                    ...
                    <div class="form-outline mb-5 DashBoardInputBx">
                      <label className="form-label" htmlFor="form3Example3">
                        {t("jobseekerEditAlert.workingRelation")}
                        <span className="RedStar">*</span>
                      </label>
                      <select
                      ...
                      >
                        <option selected value="">
                          {t("jobseekerEditAlert.selectWorkingRelation")}
                        </option>
                  ...
                  <div className="bottomButtons EditAlertButtons">
                    ...
                    >
                      {t("jobseekerEditAlert.updateButton")}
                    </button>
                    <Link
                      to="/alerts/index"
                      type="button"
                    ...
                    >
                      {t("jobseekerEditAlert.backButton")}
                    </Link>
                  </div>
                </form>
              </div>
